            ...
            <div className={`w-full bg-white ${shadow ? 'shadow-lg' : ''} rounded-sm`}>
                <div className="px-4 pt-3 pb-2 border-b border-gray-100 flex flex-wrap justify-between">
                    ...
                    <div className="w-full md:w-2/5 flex md:justify-end pt-3">
                        <div className="border-y border-amber-500 border-l rounded h-10">
                            <button
                                className="border-amber-600 h-full border-r px-3 text-amber-600 hover:bg-main hover:text-white"
                            ...
                            <button className="h-full px-2 text-amber-600 border-amber-600 border-r rounded-l hover:bg-main hover:text-white"
                                    onClick={handlePrint}>
                                <FiPrinter
