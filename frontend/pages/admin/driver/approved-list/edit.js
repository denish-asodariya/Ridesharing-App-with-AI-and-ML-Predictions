...
import { fetchDriverDetails, fetchProfile, getUserDetailsById, postUserProfileByAdmin, postUserProfileByToken, userProfilePasswordChangeAdmin, userProfilePasswordChangeAPI } from '../../../../helpers/backend_helper';
...
const DriverUpdate = () => {
    ...
    const [user, getUser] = useFetch(fetchDriverDetails, { _id: query?._id })
...
DriverUpdate.layout = AdminLayout
